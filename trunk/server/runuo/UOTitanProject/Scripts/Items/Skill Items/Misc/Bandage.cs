...
namespace Server.Items
{
	public class Bandage : Item, IDyable
	{
		...
		public class HealingContext{
			private Mobile healer;
			private Mobile patient;
			private double delay;
			private HealingProcess m_t;
			
			public HealingProcess t {get{return m_t;}}
			
			private HealingContext(Mobile healer, Mobile patient, double delay){
				this.healer = healer;
				this.patient = patient;
				this.delay = delay;
				
				m_t = new HealingProcess(delay, this);
				m_t.Start();
			}
			...
			private static Dictionary<Mobile, HealingContext> contextTable = new Dictionary<Mobile, HealingContext>();
			...
			public class HealingProcess : Timer {
				HealingContext hc;
				...
				protected override void OnTick () {
					...
					this.Stop();
					hc.m_t = null;
					Bandage.HealingContext.contextTable.Remove(hc.healer);
				}
			}
